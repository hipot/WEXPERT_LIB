...
/**
 *
 * Класс для геокодирования IP адреса через сервис ipgeobase.ru
 *
 * $o = array();
 * $o['charset'] = 'utf-8';
 * //tests
...
class Geo
{
	 ...
	 *
	 * @param
	 *        	string - ключ массива. Если интересует конкретное значение.
	 *        	Ключ может быть равным 'inetnum', 'country', 'city', 'region', 'district', 'lat', 'lng'
	 * @param
	 *        	bolean - устанавливаем хранить данные в куки или нет

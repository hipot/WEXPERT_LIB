<?
// TOFUTURE Реализовать метод определения лица, алгоритмы есть на хабре.
// TOFUTURE Реализовать метод который помещает неабрезанную картинку в дивку с нужным размером и каритка в дивке движется за мышкой
/**
...
class CImg{
	 ...
	 */
	public static function AResize($f, $w, $h=false, $m=self::M_CROP, $ch=array(true, true), $sid=false){
		return CImg::Resize($f, $w, $h, $m, $ch, $sid, true);
	}

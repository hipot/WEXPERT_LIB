 ...
 * @author &copy; WebExpert, Матяш Сергей
 * @version 3.11, 15.08.2014
 *
 * @changelog <pre>
 * 3.11
 * - добавлена кластеризация по первым трем символам в папке /cimg_cache/000/000000000000
 * </pre>
 */
class CImg
{
	 ...
	 *
	 * @param bool $ssid
	 *        	ID сайта указывается при многосайтовости
	 */
	 ...
	 */
	public static function Resize($f, $w, $h, $m, $ch = array(true, true), $sid = false, $ar = false)
	{
		$mi = new self();
		$mi->load($f);
		$mi->w_out = $w;
	 ...
	 * @see CImg::Resize()
	 */
	public static function AResize($f, $w, $h, $m, $ch = array(true, true), $sid = false, $me = false)
	{

...
$cfg['f']['eb_sphere'] = array(
	...
	'options' => array(
		array('','Выбрать'),
		array('Турагентство','Турагентство', 'selected'),
		array('Туроператор','Туроператор'),
		array('Информационные технологии','Информационные технологии'),
		array('Прочее','Прочее'),
	),
	'validate'=>array(CFValidators::filled),
);
$cfg['f']['eb_programs'] = array(
	'type' => 'textarea',
	'label'=>'Программные продукты, используемые в настоящее время',
	'class'=>'inputbox',
);
$cfg['f']['eb_variant'] = array(
	...
	'options' => array(
		array('','Выбрать'),
		array('Комплексный','Комплексный', 'selected'),
		array('Только 1-й день','Только 1-й день'),
		array('Только 2-й день','Только 2-й день'),
		array('Только вернисаж','Только вернисаж'),
	),
	'validate'=>array(CFValidators::filled),
);
$cfg['f']['eb_city'] = array(
	...
	'id'=>'eb_city',
	'options' => array(
		array('','Выбрать', 'selected'),
		array('Краснодар','Краснодар'),
		array('Ростов-на-Дону','Ростов-на-Дону'),
		array('Екатеринбург','Екатеринбург'),
		array('Тюмень','Тюмень'),
		array('Челябинск','Челябинск'),
		array('Иркутск','Иркутск'),
		array('Красноярск','Красноярск'),
		array('Казань','Казань'),
		array('Самара','Самара'),
	),
	'validate'=>array(CFValidators::filled),

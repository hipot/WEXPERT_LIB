<?
/* $arParams
 * $arParams['ELEMENT_ID'] - идентиыикатор комментируемого элемента
 ...
 * $arParams['MY_TEMPLATE_PAGER'] - если равен 'Y', то подключается местный яшаблон $templatePath.'/pager.php'
...
// конец установки ==============================================================
	...
	if ($obMenuCache->StartDataCache($arParams["CACHE_TIME"], $CACHE_ID, $CACHE_DIR)) {
		...
		if($arParams['nPageSize']>0){
			...
			// расставляем комментарии комментариев (в следующей жизни) ---

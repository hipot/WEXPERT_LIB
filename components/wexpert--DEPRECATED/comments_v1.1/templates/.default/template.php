	...
	<div class="title">Комментарии</div>
		...
		?>
			...
			<div class="tab" style="margin-left: <?=$depth*$arParams['TAB_SIZE']?>px;">
				<div class="com_date"><?=(isset($com['DATE_PARSE']))?$com['DATE_PARSE']['DD'].' '.strtolower(GetMessage('MONTH_'.(int)$com['DATE_PARSE']['MM'].'_S')):'';?> в <?=$com['DATE_PARSE']['HH'].':'.$com['DATE_PARSE']['MI']?></div>
				...
				<div class="comment_comment">
					<div class="ed">
						...
						ShowForm($iid.'_ed', $id.'_ed', array('AUTHOR_NAME'=>$com['AUTHOR_NAME'], 'AUTHOR_EMAIL'=>$com['AUTHOR_EMAIL'], 'PARENT_ID'=>$com['PARENT_ID'], 'DATE'=>$com['DATE_FORMAT'], 'IBLOCK_ELEMENT_ID'=>$arParams['ELEMENT_ID'], 'ID'=>$com['ID'], 'TEXT'=>$com['TEXT'], 'USER_ID'=>$USER->GetID()), $arParams, $arResult);
						?>
					</div>
					<div class="com">
						<?
						ShowForm($iid.'_com', $id.'_com', array('AUTHOR_NAME'=>$arResult['arUser']['NAME'], 'AUTHOR_EMAIL'=>$arResult['arUser']['EMAIL'], 'PARENT_ID'=>$com['ID'], 'IBLOCK_ELEMENT_ID'=>$arParams['ELEMENT_ID'], 'USER_ID'=>$USER->GetID()), $arParams);
						?>
					</div>
				</div>
			</div>

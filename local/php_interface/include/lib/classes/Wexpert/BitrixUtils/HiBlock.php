...
class HiBlock
{
	 ...
	 */
	static public function getDataManagerByHiId($hlblockId)
	{
	 ...
	 * @return \Bitrix\Main\Entity\DataManager
	 */
	static public function getDataManagerByHiCode($hiBlockName)
	{
		if (trim($hiBlockName) == '') {
			return false;
		}
	 ...
	 * @uses $DB
	 */
	static public function installCustomSettingsHiBlock($tableName = 'we_custom_settings', $hiBlockName = 'CustomSettings')
	{
		\CModule::IncludeModule('highloadblock');
	 ...
	 *
	 * @uses \Wexpert\BitrixUtils\PhpCacher
	 */
	static public function getCustomSettingsList($hiBlockName = 'CustomSettings', $cacheTime = 3600)
	{
		$self = __CLASS__;
	...
	/**
	 * Создать HL-блок на основе существующей таблицы
	 *
	 * @param string $tableName имя таблицы БД
	 * @return boolean
	 */
	static public function installTableToHiBlock($tableName)
	{
	}

	/**
	 * Удалить HL-блок, созданный на основе существующей таблицы
	 *
	 * @param string $tableName имя таблицы БД
	 * @return boolean
	 */
	static public function removeTableFromHiBlock($tableName)
	{
	}
}

...
require_once($_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/search/lang/ru/admin/search_sitemap.php");

require_once(dirname(__FILE__) . "/search_sm.php");

if($_REQUEST['Generate'] == 'Y') unset($_SESSION['arResURLXMLMap']);
...
function DoNext(NS)
{
	...
	if(!stop)
	{
		ShowWaitWindow();
		BX.ajax.post(
			'we_search_sitemap.php?'+queryString,
			NS,
			function(result){
